...
export class Convrtx1656771634690 implements MigrationInterface {
    name = 'Convrtx1656771634690'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_queue" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying, "name" character varying(100) NOT NULL, "image" bytea, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, CONSTRAINT "PK_bbc78902c7d22324245938dd3bf" PRIMARY KEY ("id"))`);
